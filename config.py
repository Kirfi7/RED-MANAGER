...
# команды 0+ lvl
users_commands = ['help', 'id', 'getid', 'stats', 'стата', 'жив', 'помощь']
...
# команды 3+ lvl
admin_commands = ['bzov', 'mszov', 'sszov', 'smoder', 'смодер', 'rzov']

# команды 4+ lvl
sen_admin_commands = ['admin', 'админ', 'fzov', 'quiet', 'тишина']

# команды 5+ lvl
special_commands = ['azov', 'gzov', 'lzov', 'line', 'type', 'sunbanpl', 'sbanpl', 'sunban', 'sban', 'гсопг', 'гсгосс', 'sadmin', 'садмин', 'снят', 'chat']

# команды разработчиков
dev_commands = ['spec', 'start', 'reset', 'ресет', 'log', 'gay', 'log2', 'тишина', 'crash', 'log3', 'log4', 'log5', 'quiet']
